...
export class TodosAccess {
  ...
  async updateTodo(userId: string, todoId: string, updateData: TodoUpdate): Promise<TodoItem> {
  ...
  async updateTodoAttachmentUrl(userId: string, todoId: string, attachmentUrl: string): Promise<TodoItem> {
    const result = await this.docClient.update({
      TableName: this.todosTable,
      Key: { userId, todoId },
